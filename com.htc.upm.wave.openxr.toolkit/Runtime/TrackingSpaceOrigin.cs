...
namespace Wave.OpenXR.Toolkit
{
    ...
    /// Add this component to the root of your VR camera rig in order to let other Toolkit features to find the tracking space origin and apply positional and rotational offset when needed.
    /// </summary>
