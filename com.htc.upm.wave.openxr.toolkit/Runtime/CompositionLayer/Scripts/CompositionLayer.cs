...
namespace Wave.OpenXR.Toolkit.CompositionLayer
{
	public class CompositionLayer : MonoBehaviour
	{
		...
		private const string LOG_TAG = "Wave_CompositionLayer";
		...
		{
			//Create blit mat
			texture2DBlitMaterial = new Material(Shader.Find("Wave/OpenXR/CompositionLayer/Texture2DBlitShader"));
		...
		public void UnderlayMeshGeneration()
		{
			...
			switch (layerShape)
			{
				case LayerShape.Cylinder:
					...
					generatedUnderlayMeshRenderer.sharedMaterial = new Material(Shader.Find("Wave/OpenXR/CompositionLayer/UnderlayAlphaZero"));
				...
				default:
					...
					generatedUnderlayMeshRenderer = generatedUnderlayMesh.AddComponent<MeshRenderer>();
					generatedUnderlayMeshFilter = generatedUnderlayMesh.AddComponent<MeshFilter>();
					generatedUnderlayMeshRenderer.material = new Material(Shader.Find("Wave/OpenXR/CompositionLayer/UnderlayAlphaZero"));
					generatedUnderlayMeshRenderer.material.mainTexture = texture;
